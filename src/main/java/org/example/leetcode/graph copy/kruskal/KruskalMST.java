package com.xiaodai.fund.mgmt.reconciliation.graph.kruskal;


import com.xiaodai.fund.mgmt.reconciliation.graph.Edge;
import com.xiaodai.fund.mgmt.reconciliation.graph.Graph;
import com.xiaodai.fund.mgmt.reconciliation.graph.Node;
...
//
    ...
    public static List<Edge> primMST(Graph graph) {
        ...
        PriorityQueue<Edge> queue = new PriorityQueue<>(graph.edge.size(), (o1, o2) -> o1.weight - o2.weight);
